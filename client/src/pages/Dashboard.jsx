...
const Dashboard = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Dashboard — Excelora Classes</title>
        <meta name="description" content="Your Excelora Classes dashboard. Manage matches, chats, profile status, and subscription details in one place." />
        <link rel="canonical" href="https://exceloraclasses.com/dashboard" />
      </Helmet>
