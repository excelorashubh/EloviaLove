...
import { Mail, Lock, Heart, Shield, Sparkles, CheckCircle2 } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[60%,40%] gap-8 items-center">
            ...
            >
              ...
              <div className="relative rounded-[40px] overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-pink-100 via-purple-100 to-primary-100 flex items-center justify-center">
              ...
              >
                ...
                <div className="flex items-center justify-center gap-1 mt-2">
                  {[...Array(5)].map((_, i) => (
                    <Heart key={i} size={16} className="text-amber-400" fill="currentColor" />
                  ))}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <input
                        ...
                        onChange={handleChange}
                        className="w-5 h-5 rounded-lg border-2 border-slate-300 text-primary-600 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all cursor-pointer"
                      />
                    ...
                    <Link
                      to="#"
                      className="text-sm font-bold text-primary-600 hover:text-pink-600 transition-colors"
                    >
                      Forgot Password?
                    </Link>
                  </div>
                  ...
                  <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-white/90 text-slate-500 font-semibold">
                        OR CONTINUE WITH
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      type="button"
                      className="flex items-center justify-center gap-2 py-3 px-4 bg-white border-2 border-slate-200 rounded-2xl font-semibold text-slate-700 hover:border-slate-300 hover:bg-slate-50 transition-all shadow-sm"
                    >
                    ...
                    <button
                      type="button"
                      className="flex items-center justify-center gap-2 py-3 px-4 bg-black text-white rounded-2xl font-semibold hover:bg-slate-800 transition-all shadow-sm"
                    >
