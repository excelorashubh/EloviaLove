...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      <Helmet>
        <title>Login to Excelora Classes — Secure Dating for Serious Relationships</title>
        <meta name="description" content="Access your Excelora Classes account and continue building trusted connections with verified singles in India." />
        <link rel="canonical" href="https://exceloraclasses.com/login" />
      </Helmet>
      {/* Background Decor */}
